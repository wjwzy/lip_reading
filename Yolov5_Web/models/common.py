...
from Yolov5_Web.utils.general import non_max_suppression, make_divisible, scale_coords, xyxy2xywh
from Yolov5_Web.utils.plots import color_list, plot_one_box
...
class autoShape(nn.Module):
    ...
    def forward(self, imgs, size=640, augment=False, profile=False):
        ...
        #   filename:   imgs = 'web_data/samples/zidane.jpg'
...
class Detections:
    ...
    def __init__(self, imgs, pred, files, names=None):
        ...
        self.pred = pred  # list of tensors predict[0] = (xyxy, conf, cls)
    ...
    def display(self, pprint=False, show=False, save=False, render=False, save_dir=''):
        ...
        for i, (img, pred) in enumerate(zip(self.imgs, self.pred)):
            str = f'image {i + 1}/{len(self.predict)}: {img.shape[0]}x{img.shape[1]} '
            if pred is not None:
    ...
    def tolist(self):
        ...
        for d in x:
            for k in ['imgs', 'predict', 'xyxy', 'xyxyn', 'xywh', 'xywhn']:
